        ...
        <div className="flex-1 relative h-full">
          ...
          >
            <h1 className="text-2xl font-medium text-stone-100">
              الايفون 15 برو ماكس اس سيكس سوبر فلكس
            </h1>
          ...
          >
            <h1 className="text-2xl font-medium text-stone-100">العده التتش</h1>
            <p className="text-white">عده الايفون التاتش الرهيبه اللهلوبه</p>
          </section>
        </div>
        <button
          className="hover:opacity-50 transition-opacity duration-200 cursor-pointer pointer-events-auto"
